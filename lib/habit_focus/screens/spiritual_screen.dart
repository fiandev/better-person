        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _NextMomentHero(colorScheme: colorScheme),
                ...
                LayoutBuilder(
                  builder: (context, constraints) {
                    if (constraints.maxWidth > 800) {
                      return Row(
                        ...
                        children: [
                          Expanded(
                            flex: 2,
                            child: _SpiritualMomentsSection(
                              colorScheme: colorScheme,
                            ),
                          ),
                          const SizedBox(width: 32),
                          Expanded(
                            child: _PersonalReflectionsSection(
                              colorScheme: colorScheme,
                            ),
                          ),
                        ],
                    ...
                    return Column(
                      children: [
                        _SpiritualMomentsSection(colorScheme: colorScheme),
                        const SizedBox(height: HabitFocusTheme.sectionGap),
                        _PersonalReflectionsSection(colorScheme: colorScheme),
                      ],
                    );
                  },
                ),
...
class _NextMomentHero extends StatelessWidget {
  const _NextMomentHero({required this.colorScheme});
...
class _SpiritualMomentsSection extends StatelessWidget {
  const _SpiritualMomentsSection({required this.colorScheme});
...
class _PersonalReflectionsSection extends StatelessWidget {
  const _PersonalReflectionsSection({required this.colorScheme});
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                'Read 2 pages after evening meditation to maintain daily streak.',
                style: textTheme.bodyMedium?.copyWith(
                  color: colorScheme.outline,
                ),
              ),
